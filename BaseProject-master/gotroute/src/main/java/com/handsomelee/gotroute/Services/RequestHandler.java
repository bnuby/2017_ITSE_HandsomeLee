...
public class RequestHandler {
  ...
  private static final int MAPRADIUS = 15000;
  ...
  public static void requestGooglePhoto(String photo_reference, final int index) {
//    final String url = String.format("https://maps.googleapis.com/maps/api/place/photo?maxwidth=400&photoreference=%s&key=AIzaSyCMY3fnCku6kSTiZ3AxnlCUC84YWQgUYqE", photo_reference);
//    StringRequest request = new StringRequest(url, new Response.Listener<String>() {
//      @Override
//      public void onResponse(String s) {
//        Log.i("url",url);
//        String image = new ByteArrayInputStream(s.getBytes(StandardCharsets.UTF_8)).toString();
//        MapsActivity.carParkingMarkers[index].setSnippet(image.toString().concat(MapsActivity.carParkingMarkers[index].getSnippet()));
//      }
//    }, new Response.ErrorListener() {
//      @Override
//      public void onErrorResponse(VolleyError volleyError) {
//        Log.e("Error","RequestGooglePhoto :\n" + volleyError.toString());
//      }
//    });
//    MainActivity.queue.add(request);
  }
